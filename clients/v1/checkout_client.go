...
func (c *CheckoutClient) Create(ctx context.Context, checkout *apiv1.Checkout) error {
	ctx, span := utils.SpanFromContext(ctx, "checkout.client.create")
	defer span.End()
...
func (c *CheckoutClient) Get(ctx context.Context, id uuid.UUID) (*apiv1.Checkout, error) {
	ctx, span := utils.SpanFromContext(ctx, "checkout.client.get")
	defer span.End()
	...
	if resp.StatusCode == http.StatusNotFound {
		span.RecordError(fmt.Errorf("checkout not found: %s", id.String()))
		return nil, nil
	}
...
func (c *CheckoutClient) Update(ctx context.Context, checkout *apiv1.Checkout) error {
	ctx, span := utils.SpanFromContext(ctx, "checkout.client.update")
	defer span.End()
...
func (c *CheckoutClient) Delete(ctx context.Context, id uuid.UUID) error {
	ctx, span := utils.SpanFromContext(ctx, "checkout.client.delete")
	defer span.End()
